...
Description: Advanced Custom Field with which we can select Gravityforms. Original version by Danny van Holten.
Version: 1.2.9
Author: Say Hello GmbH
Author URI: http://www.sayhello.ch/
Copyright: Say Hello GmbH, original version Danny van Holten
*/
...
define('ACF_GF_FIELD_VERSION', '1.2.7');
