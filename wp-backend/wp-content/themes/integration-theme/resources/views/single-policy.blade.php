...
@section('content')
  @introcontent(['id' => $insurance])
    <div class="row mt-3 align-items-center justify-content-between">
      <div class="col-12 col-lg-auto text-white">
          <h3 class="fw-normal fs-4 m-0 ps-4 ms-3">Apólice: <span class="fw-semi-bold">{!! get_the_title() !!}</span></h3>
      </div>
  ...
  <div class="apolice-cards container mb-5 pb-5">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-8">
        ...
        <section class="apolice-cards__download pb-3">
          <div class="row">
            @notempty($policy)
          ...
          <div class="row justify-content-end mt-4">
            <div class="col-auto">
              <button type="button" class="apolice-cards__button btn btn-dark d-block text-primary" data-bs-toggle="modal" data-bs-target="#solicitar-endosso">
                Solicitar endosso
              </button>
            </div>
          </div>
        ...
        @notempty($financial)
          ...
          <section class="apolice-cards__finance pt-3">
        ...
        @notempty($general)
          ...
          <section class="apolice-cards__documents pt-3">
        ...
        <div class="apolice-cards__change d-flex justify-content-end mb-3">
