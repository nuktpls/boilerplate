...
Object(_util_component_functions__WEBPACK_IMPORTED_MODULE_3__["enableDismissTrigger"])(Alert, 'close')
...
Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["defineJQueryPlugin"])(Alert)
...
const PLACEMENT_TOP = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'top-end' : 'top-start'
const PLACEMENT_TOPEND = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'top-start' : 'top-end'
const PLACEMENT_BOTTOM = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'bottom-end' : 'bottom-start'
const PLACEMENT_BOTTOMEND = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'bottom-start' : 'bottom-end'
const PLACEMENT_RIGHT = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'left-start' : 'right-start'
const PLACEMENT_LEFT = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'right-start' : 'left-start'
...
class Dropdown extends _base_component__WEBPACK_IMPORTED_MODULE_5__["default"] {
  ...
  show() {
    if (Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isDisabled"])(this._element) || this._isShown(this._menu)) {
      return
    }
  ...
  _createPopper(parent) {
    ...
    if (this._config.reference === 'parent') {
      ...
      referenceElement = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["getElement"])(this._config.reference)
    } else if (typeof this._config.reference === 'object') {
      referenceElement = this._config.reference
    }
  ...
  _selectMenuItem({ key, target }) {
    ...
    // if target isn't included in items (e.g. when expanding the dropdown)
    // allow cycling to get the last item in case key equals ARROW_UP_KEY
    Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["getNextActiveElement"])(items, target, key === ARROW_DOWN_KEY, !items.includes(target)).focus()
  }
  ...
  static dataApiKeydownHandler(event) {
    ...
    if (Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isDisabled"])(this)) {
      return
    }
...
Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["defineJQueryPlugin"])(Dropdown)
...
class Tab extends _base_component__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  show() {
    ...
    let previous
    const target = Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["getElementFromSelector"])(this._element)
    const listElement = this._element.closest(SELECTOR_NAV_LIST_GROUP)
...
_dom_event_handler__WEBPACK_IMPORTED_MODULE_1__["default"].on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
  ...
  if (Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["isDisabled"])(this)) {
    return
  }
...
Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["defineJQueryPlugin"])(Tab)
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Alert", function() { return bootstrap_js_src_alert__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Dropdown", function() { return bootstrap_js_src_dropdown__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Modal", function() { return bootstrap_js_src_modal__WEBPACK_IMPORTED_MODULE_2__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Tab", function() { return bootstrap_js_src_tab__WEBPACK_IMPORTED_MODULE_3__["default"]; });
...
/* harmony import */ var _autoload_bootstrap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./autoload/_bootstrap */ "./resources/assets/scripts/autoload/_bootstrap.js");
...
var configLogin = {
  ...
  errorMsg: "Autorização negada, verifique as suas credenciais e tente novamente.",
  errorElement: "message-error",
  successElement: "message-success"
};
/* harmony default export */ __webpack_exports__["default"] = (configLogin);
...
var configSignupRequest = {
  ...
  configHeadersFrom: "From: Número 1 Seguros Teste <mbolonha@studiovisual.com.br>",
  ...
  inputsId: "nomeCompleto telNo emailEmpresa nomeEmpresa dadosEmpresa mensagemEmpresa"
};
/* harmony default export */ __webpack_exports__["default"] = (configSignupRequest);
...
var modalIntegration = function modalIntegration(config) {
  if (document.readyState !== "loading") {
    var documentModal = new bootstrap.Modal(document.getElementById(config.modalTermsId));
    documentModal.show();
  }
};

/* harmony default export */ __webpack_exports__["default"] = (modalIntegration);
...
var checkTermsCookies = function checkTermsCookies() {
  if (document.readyState == "complete") {
    var cookieCheck = document.cookie ? document.cookie.includes("signUp=true") : null;
...
/* harmony default export */ __webpack_exports__["default"] = (checkTermsCookies);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var identifyChange = function identifyChange(inputs, dataObj, indexInputs, totalObjs, signPlus) {
  // return the modified obj
  var id = inputs.id;
  var value = inputs.value;
  totalObjs = signPlus ? totalObjs - 1 : totalObjs + 1;
  dataObj.splice(dataObj.findIndex(function (eI) {
    return eI.id === id;
  }), 1);
  return dataObj.push({
    id: id,
...
/* harmony default export */ __webpack_exports__["default"] = (identifyChange);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fade_in_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fade-in-container */ "./resources/assets/scripts/modules/containers/fade-in-container.js");
/* harmony import */ var _fade_out_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fade-out-container */ "./resources/assets/scripts/modules/containers/fade-out-container.js");



var isFormFilled = function isFormFilled(config, filledForm, data, submitHandler, successElement) {
  ...
  document.getElementById(config.submitFormBtn).addEventListener("click", function (es) {
    var form = document.getElementById("sign-up-form"); // habilitar submit login

    var whatHere = document.cookie ? document.cookie.includes("signUp=true") : null;

    if (whatHere[1] === true) {
      document.getElementById("wp-submit").removeAttribute("disabled");
    }

    Object(_fade_out_container__WEBPACK_IMPORTED_MODULE_1__["default"])(form, 100);
    window.setTimeout(function () {
    ...
    submitHandlerConst.onload = function (e) {
      ...
      var responseRequest = submitHandler.response && submitHandler.response.data && submitHandler.response.data.type ? submitHandler.response.data.type : null;
      ...
      if (responseRequest === "error") {
        ...
        Object(_fade_in_container__WEBPACK_IMPORTED_MODULE_0__["default"])(successElement, 1200);
        document.getElementById(config.submitFormBtn).setAttribute("disabled", true);
        document.getElementById("cadastro-modal-label").innerText = "";
      } else {
        errorElement.innerText = config.errorMsg;
        Object(_fade_in_container__WEBPACK_IMPORTED_MODULE_0__["default"])(errorElement, 1200);
...
/* harmony default export */ __webpack_exports__["default"] = (isFormFilled);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _submit_handler_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./submit-handler-container */ "./resources/assets/scripts/modules/containers/submit-handler-container.js");
/* harmony import */ var _contact_identify_changes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./contact-identify-changes */ "./resources/assets/scripts/modules/containers/contact-identify-changes.js");
/* harmony import */ var _form_filled_container_copy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./form-filled-container copy */ "./resources/assets/scripts/modules/containers/form-filled-container copy.js");
/* harmony import */ var _form_not_filled_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./form-not-filled-container */ "./resources/assets/scripts/modules/containers/form-not-filled-container.js");





var formListenerActions = function formListenerActions(formsInputs, totalObjs, config, data) {
  var dataObj = [];
  var filledForm = [];
  ...
  formsInputs.map(function (inputs, indexInputs) {
    inputs.addEventListener("input", function () {
      ...
      if (cpfCNPJ.value.length > 18) {
        document.getElementById("dadosEmpresa").value = document.getElementById("dadosEmpresa").value.slice(0, -1);
      }
      ...
      Object(_contact_identify_changes__WEBPACK_IMPORTED_MODULE_1__["default"])(inputs, dataObj, indexInputs, totalObjs, signPlus);
      ...
      var nomeCompletoArr = document.getElementById("nomeCompleto").value.split(" ");
      var nomeCompletoCheck = nomeCompletoArr[1] && nomeCompletoArr[0] !== "" && nomeCompletoArr[1] !== "" ? true : false;
      var telNoCheck = document.getElementById("telNo").value.length >= 14 ? true : false;
      var emailEmpresaCheckOne = document.getElementById("emailEmpresa").value.includes("@") ? true : false;
      var emailEmpresaCheckTwo = document.getElementById("emailEmpresa").value.includes(".") ? true : false;
      var emailEmpresaCheckThree = document.getElementById("emailEmpresa").value.length >= 8 ? true : false;
      var emailEmpresaCheck = emailEmpresaCheckOne && emailEmpresaCheckTwo && emailEmpresaCheckThree ? true : false;
      var nomeEmpresaCheck = document.getElementById("nomeEmpresa").value.length >= 3 ? true : false;
      var dadosEmpresaCheckOne = document.getElementById("dadosEmpresa").value.length >= 9 ? true : false;
      var dadosEmpresaCheckTwo = document.getElementById("dadosEmpresa").value.length === 14 ? true : false;
      var dadosEmpresaCheckThree = document.getElementById("dadosEmpresa").value.length === 18 ? true : false;
      var dadosEmpresaCheckFour = document.getElementById("dadosEmpresa").value.length < 19 ? true : false;
      var dadosEmpresaCheck = dadosEmpresaCheckOne && dadosEmpresaCheckFour && (dadosEmpresaCheckTwo || dadosEmpresaCheckThree) ? true : false;
      var mensagemEmpresaCheck = document.getElementById("mensagemEmpresa").value.length >= 6 ? true : false;
      var everyThingOk = nomeCompletoCheck && telNoCheck && emailEmpresaCheck && nomeEmpresaCheck && dadosEmpresaCheck && mensagemEmpresaCheck ? true : false;

      if (filledForm.length === 6 && !hasEmpty && document.getElementById("sign-up-termos").checked) {
        if (everyThingOk) {
          document.getElementById("modal-message-error").style.display = "none";
          Object(_form_filled_container_copy__WEBPACK_IMPORTED_MODULE_2__["default"])(config, filledForm, data, _submit_handler_container__WEBPACK_IMPORTED_MODULE_0__["default"], successElement, everyThingOk);
        }

        return true;
      } else {
        document.getElementById("modal-message-error").style.display = "block";
        document.getElementById("modal-message-error").innerHTML = "<p>Por favor, preencha corretamente o(s) seguinte(s) campo(s):</p>\n                  <ul>\n                    ".concat(!nomeCompletoCheck ? "<li>Nome e Sobrenome</li>" : "", "\n                    ").concat(!telNoCheck ? "<li>Telefone</li>" : "", "\n                    ").concat(!emailEmpresaCheck ? "<li>E-mail</li>" : "", "\n                    ").concat(!nomeEmpresaCheck ? "<li>Empresa</li>" : "", "\n                    ").concat(!dadosEmpresaCheck ? "<li>CPF/CNPJ</li>" : "", "\n                    ").concat(!mensagemEmpresaCheck ? "<li>Mensagem</li>" : "", "\n                  </ul>");
        Object(_form_not_filled_container__WEBPACK_IMPORTED_MODULE_3__["default"])(config.submitFormBtn);
        return false;
      }
    });
  });
...
/* harmony default export */ __webpack_exports__["default"] = (formListenerActions);
...
/* harmony default export */ __webpack_exports__["default"] = (isFormNotFilled);
...
var onLoadResponse = function onLoadResponse(submitHandler, config, errorElement) {
...
/* harmony default export */ __webpack_exports__["default"] = (onLoadResponse);
...
/* harmony default export */ __webpack_exports__["default"] = (submitHandler);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _submit_handler_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./submit-handler-container */ "./resources/assets/scripts/modules/containers/submit-handler-container.js");
/* harmony import */ var _terms_ribbon_hide_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./terms-ribbon-hide-container */ "./resources/assets/scripts/modules/containers/terms-ribbon-hide-container.js");



var termsContainer = function termsContainer(checkboxIds, btnsIds, config) {
        ...
        for (var ai = 0; ai < btnList.length; ai++) {
          ...
          if (itemBtn) {
            ...
            itemBtn.addEventListener("click", function () {
              ...
              var submitHandlerTermsCookieConst = Object(_submit_handler_container__WEBPACK_IMPORTED_MODULE_0__["default"])(config, data);

              submitHandlerTermsCookieConst.onload = function () {
                console.log(submitHandlerTermsCookieConst.response.data.type);
              };

              Object(_terms_ribbon_hide_container__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById(config.termsRibbonId), 200);
            }); // btn reactive fx's
            ...
            if (e.target.checked !== true) {
              ...
              if (itemBtn.getAttribute("disabled")) {
                ...
                for (var indexExc = 0; indexExc < btnsExceptions.length; indexExc++) {
...
/* harmony default export */ __webpack_exports__["default"] = (termsContainer); // declare exceptions disables
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _submit_handler_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./submit-handler-container */ "./resources/assets/scripts/modules/containers/submit-handler-container.js");
/* harmony import */ var _terms_ribbon_hide_container_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./terms-ribbon-hide-container.js */ "./resources/assets/scripts/modules/containers/terms-ribbon-hide-container.js");
/* harmony import */ var _bootstrap_modal_integration_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bootstrap-modal-integration-container */ "./resources/assets/scripts/modules/containers/bootstrap-modal-integration-container.js");
...
var termsStatus = function termsStatus(config) {
  if (document.readyState !== "loading") {
    ...
    var submitStatusHandler = Object(_submit_handler_container__WEBPACK_IMPORTED_MODULE_0__["default"])(config, data);
    ...
    submitStatusHandler.onload = function () {
      ...
      if (submitStatusHandler.response.data.type === "warn") {
        ...
        Object(_terms_ribbon_hide_container_js__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById(config.termsRibbonId), 20);
        document.cookie = "signUp=true";
      } else {
        // on.load/window.cache!=true
        // show terms modal
        config.termsOnLoad ? Object(_bootstrap_modal_integration_container__WEBPACK_IMPORTED_MODULE_2__["default"])(config) : null;
      }
    };
  }
};

/* harmony default export */ __webpack_exports__["default"] = (termsStatus);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _slide_down_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slide-down-container */ "./resources/assets/scripts/modules/containers/slide-down-container.js");
...
var hideTerms = function hideTerms(target) {
  ...
  if (target.style.display != "none") {
    for (var index = 0; index < 1; index++) {
      return Object(_slide_down_container__WEBPACK_IMPORTED_MODULE_0__["default"])(target, duration);
    }
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _containers_masker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./containers/masker */ "./resources/assets/scripts/modules/containers/masker.js");
/* harmony import */ var _containers_masker__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_containers_masker__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _containers_check_terms_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./containers/check-terms-container */ "./resources/assets/scripts/modules/containers/check-terms-container.js");
...
var cookiesOnLoad = function cookiesOnLoad() {
  ...
  document.addEventListener("change", function () {
    Object(_containers_check_terms_container__WEBPACK_IMPORTED_MODULE_1__["default"])();
  });
  ...
  document.onreadystatechange = function () {
    function inputHandler(masks, max, event) {
      ...
      _containers_masker__WEBPACK_IMPORTED_MODULE_0___default()(c).unMask();
      _containers_masker__WEBPACK_IMPORTED_MODULE_0___default()(c).maskPattern(masks[m]);
      c.value = _containers_masker__WEBPACK_IMPORTED_MODULE_0___default.a.toPattern(v, masks[m]);
    }

    var telMask = ["(99) 9999-99999", "(99) 99999-9999"];
    var tel = document.getElementById("telNo");
    _containers_masker__WEBPACK_IMPORTED_MODULE_0___default()(tel).maskPattern(telMask[0]);
    tel.addEventListener("input", inputHandler.bind(undefined, telMask, 14), false);
    var docMask = ["999.999.999-999", "99.999.999/9999-99"];
    var doc = document.getElementById("dadosEmpresa");
    _containers_masker__WEBPACK_IMPORTED_MODULE_0___default()(doc).maskPattern(docMask[0]);
    doc.addEventListener("input", inputHandler.bind(undefined, docMask, 14), false);
    Object(_containers_check_terms_container__WEBPACK_IMPORTED_MODULE_1__["default"])();
  };
};

/* harmony default export */ __webpack_exports__["default"] = (cookiesOnLoad);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _containers_submit_handler_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./containers/submit-handler-container */ "./resources/assets/scripts/modules/containers/submit-handler-container.js");
/* harmony import */ var _containers_fade_in_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./containers/fade-in-container */ "./resources/assets/scripts/modules/containers/fade-in-container.js");
/* harmony import */ var _containers_on_load_response_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./containers/on-load-response-container */ "./resources/assets/scripts/modules/containers/on-load-response-container.js");
...
var LoginAjaxRequest = function LoginAjaxRequest(config) {
  ...
  var cookieSignup = document.cookie ? document.cookie.includes("signUp=true") : null;
  ...
  button.addEventListener("click", function (e) {
    ...
    if (inputUser.value === "") {
      ...
      return Object(_containers_fade_in_container__WEBPACK_IMPORTED_MODULE_1__["default"])(errorElement, 600);
    } // block empty value
    ...
    var submitHandlerConst = Object(_containers_submit_handler_container__WEBPACK_IMPORTED_MODULE_0__["default"])(config, data); // submit.onload XMLHttpRequest function
    // on load request response

    Object(_containers_on_load_response_container__WEBPACK_IMPORTED_MODULE_2__["default"])(submitHandlerConst, config, errorElement);
  }); // say what ?

  return;
};

/* harmony default export */ __webpack_exports__["default"] = (LoginAjaxRequest);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _containers_form_listener_actions_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./containers/form-listener-actions-container */ "./resources/assets/scripts/modules/containers/form-listener-actions-container.js");
/* harmony import */ var _config_signup_request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/signup-request */ "./resources/assets/scripts/modules/config/signup-request.js");



var requestSignupResolver = function requestSignupResolver() {
  var form = document.getElementById(_config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].form);
  Object.values(form).reduce(function (obj, field) {
    obj[field.name] = field.value; // console.log(obj);

    return obj;
  }, {});
  var contactName = document.getElementById(_config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].contactNameId);
  var phoneNumber = document.getElementById(_config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].phoneNumberId);
  var businessEmail = document.getElementById(_config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].businessEmailId);
  var businessName = document.getElementById(_config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].businessNameId);
  var businessCountryRegister = document.getElementById(_config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].businessCountryRegisterId);
  var contactMessage = document.getElementById(_config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].contactMessageId);
  var formsInputs = [contactName, phoneNumber, businessEmail, businessName, businessCountryRegister, contactMessage];
  var myInputsArr = [];
  ...
  var data = {
    action: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].action,
    configTo: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].configTo,
    configSubject: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].configSubject,
    configBody: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].configBody,
    configHeadersFrom: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].configHeadersFrom,
    configHeadersCC: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].configHeadersCC
  };
  var config = {
    ajax_url: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].ajax_url,
    redirect: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].redirect,
    errorElement: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].errorElement,
    successElement: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].successElement,
    successMsg: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].successMsg,
    errorMsg: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].errorMsg,
    submitFormBtn: _config_signup_request__WEBPACK_IMPORTED_MODULE_1__["default"].submitFormBtn
  };
  var totalObjs = formsInputs.length;
  Object(_containers_form_listener_actions_container__WEBPACK_IMPORTED_MODULE_0__["default"])(formsInputs, totalObjs, config, data);
};

/* harmony default export */ __webpack_exports__["default"] = (requestSignupResolver);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _config_terms_ribbon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/terms-ribbon */ "./resources/assets/scripts/modules/config/terms-ribbon.js");
/* harmony import */ var _containers_terms_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./containers/terms-container */ "./resources/assets/scripts/modules/containers/terms-container.js");
/* harmony import */ var _containers_terms_get_status_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./containers/terms-get-status-container */ "./resources/assets/scripts/modules/containers/terms-get-status-container.js");
...
var TermsActions = function TermsActions() {
  ...
  Object(_containers_terms_get_status_container__WEBPACK_IMPORTED_MODULE_2__["default"])(_config_terms_ribbon__WEBPACK_IMPORTED_MODULE_0__["default"]); // terms accept buttons listening multiple id's
  // avoid acceptance without reading the terms
  // multiple checkbox acceptance

  Object(_containers_terms_container__WEBPACK_IMPORTED_MODULE_1__["default"])(_config_terms_ribbon__WEBPACK_IMPORTED_MODULE_0__["default"].acceptCheckbox, _config_terms_ribbon__WEBPACK_IMPORTED_MODULE_0__["default"].acceptBtns, _config_terms_ribbon__WEBPACK_IMPORTED_MODULE_0__["default"]); // RESET FUNCTION 4Dev
...
/* harmony default export */ __webpack_exports__["default"] = (TermsActions);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/forms */ "./resources/assets/scripts/modules/forms.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_login_ajax__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/login-ajax */ "./resources/assets/scripts/modules/login-ajax.js");
/* harmony import */ var _modules_config_login_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/config/login-form */ "./resources/assets/scripts/modules/config/login-form.js");
/* harmony import */ var _modules_terms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/terms */ "./resources/assets/scripts/modules/terms.js");
/* harmony import */ var _modules_request_signup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/request-signup */ "./resources/assets/scripts/modules/request-signup.js");
/* harmony import */ var _modules_cookies_onload__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../modules/cookies-onload */ "./resources/assets/scripts/modules/cookies-onload.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  init: function init() {
    ...
    // Accept terms button
    new _modules_cookies_onload__WEBPACK_IMPORTED_MODULE_4__["default"]();
    new _modules_login_ajax__WEBPACK_IMPORTED_MODULE_0__["default"](_modules_config_login_form__WEBPACK_IMPORTED_MODULE_1__["default"]);
    new _modules_terms__WEBPACK_IMPORTED_MODULE_2__["default"]();
    new _modules_request_signup__WEBPACK_IMPORTED_MODULE_3__["default"]();
  },
